    ...
    <div class="col-md-6">
        <form method="post" action="/user/signup">
            <div class="form-group">
                ...
                <input name="login" type="text" class="form-control" id="login" value="<?= isset($_SESSION['form_data']['login']) ? helpers\htmlSecure($_SESSION['form_data']['login']) : ''; ?>">
            ...
            <div class="form-group">
                ...
                <input name="email" type="text" class="form-control" id="email" aria-describedby="email" value="<?= isset($_SESSION['form_data']['email']) ? helpers\htmlSecure($_SESSION['form_data']['email']) : ''; ?>">
            ...
            <div class="form-group">
                ...
                <input name="password" type="password" class="form-control" id="password" value="<?= isset($_SESSION['form_data']['password']) ? helpers\htmlSecure($_SESSION['form_data']['password']) : ''; ?>">
            ...
            <div class="form-group">
                ...
                <input name="password_conf" type="password" class="form-control" id="password_conf" value="<?= isset($_SESSION['form_data']['password_conf']) ? helpers\htmlSecure($_SESSION['form_data']['password_conf']) : ''; ?>">
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="is_apply_rules">Cогласие с <a href="/page/rules">правилами</a> сайта</label>
